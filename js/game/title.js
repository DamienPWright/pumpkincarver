...
TitleScreen.prototype.preload = function(){
    ...
    game.load.spritesheet('player_bones', 'assets/img/sprites/bones.png', 64, 64);
...
TitleScreen.prototype.create = function(){
    ...
    game.add.text(this.selPosX, this.selPosY[0], 'Map Test', {font: '10px Arial', fill: '#FFF'});
    game.add.text(this.selPosX, this.selPosY[1], 'Nothing', {font: '10px Arial', fill: '#FFF'});
    game.add.text(this.selPosX, this.selPosY[2], 'Nothing', {font: '10px Arial', fill: '#FFF'});
    game.add.text(this.selPosX, this.selPosY[3], 'Nothing', {font: '10px Arial', fill: '#FFF'});
